...
class TasacionSolohoySerializer (serializers.ModelSerializer):
   ...
   class Meta:
        ...
        #fields = ('Secuenciaproceso','Secuenciaregistro','Nude_ciudada','Nude_operadora','Nude_paisa','Nuor_ciudada','Nuor_paisa','Nuor_operadora','Secuenciareproceso','Fechahora','Nuor_operador','Nude_operador')
        fields = ('Secuenciaproceso','Secuenciaregistro','Secuenciareproceso','Fechahora','Numeroorigen','Nuor_ciudada','Nuor_paisa','Nuor_operadora',
            'Nuor_servicio','Numerodestino','Nude_ciudada','Nude_operadora','Nude_paisa','Nude_servicio','Numerossee','Rutaentradaa','Ruen_operador',
            'ruen_pais','Ruen_servicio','Rutasalidaa','Rusa_operador','Rusa_pais','Rusa_servicio','Prefijo','Segundos','Modalidad','Seor_serie','Seor_operador','Seor_servicio','Seor_ciudad','Sede_serie','Sede_operador','Sede_servicio','Sede_ciudad','Sse_flag','Fuente','Flagcruce','Observacion','Match_fecha','Match_hora','Match_xxxx')#
